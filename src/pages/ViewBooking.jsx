        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {booking.Facility && (
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                <div>
                  <label className="block text-sm font-medium text-gray-500 mb-1">Facility Name</label>
                  <p className="text-gray-900 font-medium">{booking.Facility.name}</p>
                </div>
                
                <div>
                  <label className="block text-sm font-medium text-gray-500 mb-1">Address</label>
                  <p className="text-gray-900">{booking.Facility.address}</p>
                </div>
                
                {booking.Facility.contactInfo && (
                  <div>
                    <label className="block text-sm font-medium text-gray-500 mb-1">Contact Info</label>
                    <p className="text-gray-900">{JSON.stringify(booking.Facility.contactInfo)}</p>
                  </div>
                )}
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-gray-900">{booking.participantsCount}</span>
              </div>
